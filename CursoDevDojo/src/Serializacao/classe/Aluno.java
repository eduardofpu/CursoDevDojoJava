...
// na Serialização o java não chama o construtor
public class Aluno extends Pessoa implements Serializable{
	...
	public String toString() {
		return "Aluno [id=" + id + ", nome=" + nome + ", password=" + password + ", nomeEscola=" + nomeEscola + ",turma=" + turma + "]";
	}
	//metodo sera chamado com serializar-mos
